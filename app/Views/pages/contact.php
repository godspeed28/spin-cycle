...
<div class="container mt-5">
    <div class="container bg-light p-5 pindah-bawah" style="max-width: 500px;">
        ...
        <form id="formSaya" action="<?= base_url('kirim-email') ?>" method="post">
            <?php if (session()->getFlashdata('success')): ?>
                <div class="mt-2 alert alert-success"><?= session()->getFlashdata('success') ?></div>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <div class="mb-3 mt-3">
                <input type="text" class="form-control rounded-0" name="nama" placeholder="Your name">
            </div>
            <div class="mb-3 w-100 d-flex flex-wrap gap-3">
                <input type="email" class="form-control rounded-0" name="email" style="flex: 1 1 45%;" placeholder="E-mail" required>
                <input type="tel" class="form-control rounded-0" name="phone" style="flex: 1 1 45%;" placeholder="Phone" required>
            </div>
            <div class="mb-3">
                <textarea class="form-control rounded-0" name="message" placeholder="Your message" rows="4"></textarea>
            </div>
